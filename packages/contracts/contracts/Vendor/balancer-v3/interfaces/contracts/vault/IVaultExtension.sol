...
interface IVaultExtension {
    ...
    *******************************************************************************/
    ...
    function allowance(
        ...
        address owner,
        address spender
    ) external view returns (uint256 tokenAllowance);
    ...
    *******************************************************************************/
    ...
    function getPoolPausedState(
        ...
        returns (
            bool poolPaused,
            uint32 poolPauseWindowEndTime,
            uint32 poolBufferPeriodEndTime,
    ...
    *******************************************************************************/
    ...
    ) external view returns (bool isBufferInitialized);
    ...
    *******************************************************************************/
    ...
    function getAggregateSwapFeeAmount(
        address pool,
        IERC20 token
    ) external view returns (uint256 swapFeeAmount);
    ...
    function getAggregateYieldFeeAmount(
        address pool,
        IERC20 token
    ) external view returns (uint256 yieldFeeAmount);
    ...
    function getProtocolFeeController()
        external
        view
        returns (IProtocolFeeController protocolFeeController);
