...
import {IERC20Metadata} from "../../dependencies/openzeppelin/contracts/interfaces/IERC20Metadata.sol";
import {IERC20Permit} from "../../dependencies/openzeppelin/contracts/interfaces/IERC20Permit.sol";
import {ERC165} from "../../dependencies/openzeppelin/contracts/utils/introspection/ERC165.sol";
import {EIP712} from "../../dependencies/openzeppelin/contracts/utils/cryptography/EIP712.sol";
import {ECDSA} from "../../dependencies/openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import {IERC20} from "../../dependencies/openzeppelin/contracts/interfaces/IERC20.sol";
import {Nonces} from "../../dependencies/openzeppelin/contracts/utils/Nonces.sol";

import {IRateProvider} from "../../interfaces/contracts/solidity-utils/helpers/IRateProvider.sol";
import {IVault} from "../../interfaces/contracts/vault/IRateProvider.sol";

import {VaultGuard} from "./VaultGuard.sol";

/**
 * @notice `BalancerPoolToken` is a fully EBaBalaRC20-compatible token to be used as the base contract for Balancer Pools,
    ...
    VaultGuard
{
    ...
    constructor(
        IVault vault_,
        string memory bptName,
        string memory bptSymbol
    ) EIP712(bptName, "1") VaultGuard(vault_) {
        _bptName = bptName;
