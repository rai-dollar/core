...
import {IVaultAdminMock} from "../../../v3-interfaces/contracts/test/IVaultAdminMock.sol";
...
contract VaultAdminMock is IVaultAdminMock, VaultAdmin {
    ...
    function mockWithValidPercentage(
        uint256 percentage
    ) external pure withValidPercentage(percentage) {
