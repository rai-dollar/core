...
library BasePoolMath {
    ...
    function computeAddLiquidityUnbalanced(
        ...
        ***********************************************************************/
        ...
        uint256 invariantRatio = pool.computeInvariant(newBalances, Rounding.ROUND_DOWN).divDown(
            currentInvariant
        );
    ...
    function computeRemoveLiquiditySingleTokenExactOut(
        ...
        uint256 invariantRatio = pool.computeInvariant(newBalances, Rounding.ROUND_UP).divUp(
            currentInvariant
        );
        ...
        bptAmountIn = totalSupply.mulDivUp(
    ...
    function computeRemoveLiquiditySingleTokenExactIn(
        ...
        uint256 newBalanceBeforeTax = newSupply.mulDivUp(
