...
import {IRouter} from "../../v3-interfaces/contracts/vault/IRouter.sol";
...
contract Router is IRouter, RouterCommon {
    ...
    ***************************************************************************/
    ...
    function removeLiquiditySingleTokenExactOut(
        ...
        (uint256[] memory minAmountsOut, ) = _getSingleInputArrayAndTokenIndex(
            pool,
            tokenOut,
            exactAmountOut
        );
    ...
    function queryRemoveLiquidityRecovery(
        ...
        return
            abi.decode(
                _vault.quote(
                    abi.encodeCall(
                        Router.queryRemoveLiquidityRecoveryHook,
