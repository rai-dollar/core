...
import {TransientStorageHelpers, TokenDeltaMappingSlotType, UintToAddressToBooleanMappingSlot} from "../../v3-solidity-utils/contracts/helpers/TransientStorageHelpers.sol";
...
contract VaultStorage {
    ...
    ***************************************************************************/
    ...
    bytes32 private immutable _NON_ZERO_DELTA_COUNT_SLOT =
        _calculateVaultStorageSlot("nonZeroDeltaCount");
    ...
    bytes32 private immutable _ADD_LIQUIDITY_CALLED_SLOT =
        _calculateVaultStorageSlot("addLiquidityCalled");
    ...
    ***************************************************************************/
    ...
    mapping(address pool => mapping(IERC20 token => bytes32 packedFeeAmounts))
        internal _aggregateFeeAmounts;
    ...
    ***************************************************************************/
    ...
    mapping(IERC4626 wrappedToken => mapping(address user => uint256 userShares))
        internal _bufferLpShares;
