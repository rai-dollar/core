...
import {FEE_BITLENGTH} from "../../../v3-interfaces/contracts/vault/VaultTypes.sol";
...
library PoolConfigConst {
    ...
    uint256 public constant DECIMAL_SCALING_FACTORS_OFFSET =
        AGGREGATE_YIELD_FEE_OFFSET + FEE_BITLENGTH;
