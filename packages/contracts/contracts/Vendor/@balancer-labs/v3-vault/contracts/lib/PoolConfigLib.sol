...
library PoolConfigLib {
        ...
        return
            PoolConfigBits.wrap(
                PoolConfigBits.unwrap(config).insertBool(
                    value,
                    PoolConfigConst.POOL_REGISTERED_OFFSET
                )
            );
    }
    ...
    function setPoolInitialized(
        ...
        return
            PoolConfigBits.wrap(
                PoolConfigBits.unwrap(config).insertBool(
                    value,
                    PoolConfigConst.POOL_INITIALIZED_OFFSET
                )
            );
    }
    ...
    function setPoolPaused(
        ...
        return
            PoolConfigBits.wrap(
                PoolConfigBits.unwrap(config).insertBool(value, PoolConfigConst.POOL_PAUSED_OFFSET)
            );
    }
    ...
    function setPoolInRecoveryMode(
        PoolConfigBits config,
        bool value
    ) internal pure returns (PoolConfigBits) {
        return
            PoolConfigBits.wrap(
                PoolConfigBits.unwrap(config).insertBool(
                    value,
                    PoolConfigConst.POOL_RECOVERY_MODE_OFFSET
                )
            );
    }
    ...
    function supportsUnbalancedLiquidity(PoolConfigBits config) internal pure returns (bool) {
        ...
        return
            !PoolConfigBits.unwrap(config).decodeBool(PoolConfigConst.UNBALANCED_LIQUIDITY_OFFSET);
    }
    ...
    function supportsRemoveLiquidityCustom(PoolConfigBits config) internal pure returns (bool) {
        return
            PoolConfigBits.unwrap(config).decodeBool(PoolConfigConst.REMOVE_LIQUIDITY_CUSTOM_OFFSET);
    }
    ...
    function setDonation(
        ...
        return
            PoolConfigBits.wrap(
                PoolConfigBits.unwrap(config).insertBool(
                    enableDonation,
                    PoolConfigConst.DONATION_OFFSET
                )
            );
    }
    ...
    function setPauseWindowEndTime(
        PoolConfigBits config,
        uint32 value
    ) internal pure returns (PoolConfigBits) {
        return
