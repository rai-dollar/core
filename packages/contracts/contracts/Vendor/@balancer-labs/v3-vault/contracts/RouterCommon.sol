...
import {IERC20Permit} from "../../dependencies/@openzeppelin/contracts/token/ERC20/extensions/IERC20Permit.sol";
...
import {IRouterCommon} from "../../v3-interfaces/contracts/vault/IRouterCommon.sol";
import {IWETH} from "../../v3-interfaces/contracts/solidity-utils/misc/IWETH.sol";
...
import {Version} from "../../v3-solidity-utils/contracts/helpers/Version.sol";
 ...
 */
abstract contract RouterCommon is
    IRouterCommon,
    SenderGuard,
    VaultGuard,
    ...
    Version
{
    ...
    *******************************************************************************/
    ...
    function _permitBatch(
        ...
        for (uint256 i = 0; i < permitBatch.length; ++i) {
                ...
                )
            {
                ...
                if (
                    IERC20(permitApproval.token).allowance(permitApproval.owner, address(this)) !=
                    permitApproval.amount
                ) {
    ...
    ) private pure returns (SignatureParts memory signatureParts) {
        bytes32 r;
        bytes32 s;
        uint8 v;
