...
import {ISwapFeePercentageBounds} from "../../v3-interfaces/contracts/vault/ISwapFeePercentageBounds.sol";
import {PoolData, Rounding} from "../../v3-interfaces/contracts/vault/VaultTypes.sol";
import {IVaultErrors} from "../../v3-interfaces/contracts/vault/IVaultErrors.sol";
import {IVaultEvents} from "../../v3-interfaces/contracts/vault/IVaultEvents.sol";
...
import {ReentrancyGuardTransient} from "../../v3-solidity-utils/contracts/openzeppelin/ReentrancyGuardTransient.sol";
    ...
    ERC20MultiToken
{
    ...
    *******************************************************************************/
    ...
    function _getPoolPausedState(address pool) internal view returns (bool, uint32) {
        ...
        // solhint-disable-next-line not-rely-on-time
        return (
            isPoolPaused && block.timestamp <= pauseWindowEndTime + _vaultBufferPeriodDuration,
            pauseWindowEndTime
        );
    }
    ...
    *******************************************************************************/
     ...
     */
    function _ensureCorrectBufferAsset(
    ...
    *******************************************************************************/
    ...
    function _updateRawAndLiveTokenBalancesInPoolData(
        ...
        function(uint256, uint256, uint256)
            internal
            pure
            returns (uint256) _upOrDown = roundingDirection == Rounding.ROUND_UP
