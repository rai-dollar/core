...
import {IBasePoolFactory} from "../../v3-interfaces/contracts/vault/IBasePoolFactory.sol";
import {IVault} from "../../v3-interfaces/contracts/vault/IVault.sol";
import {TokenConfig, PoolRoleAccounts, LiquidityManagement} from "../../v3-interfaces/contracts/vault/VaultTypes.sol";

import {BaseSplitCodeFactory} from "../../v3-solidity-utils/contracts/helpers/BaseSplitCodeFactory.sol";
import {FactoryWidePauseWindow} from "../../v3-solidity-utils/contracts/helpers/FactoryWidePauseWindow.sol";
import {SingletonAuthentication} from "../../v3-vault/contracts/SingletonAuthentication.sol";
    ...
    FactoryWidePauseWindow
{
     ...
     */
    function getDefaultLiquidityManagement()
        public
        pure
        returns (LiquidityManagement memory liquidityManagement)
    {
        // solhint-disable-previous-line no-empty-blocks
    }
}
